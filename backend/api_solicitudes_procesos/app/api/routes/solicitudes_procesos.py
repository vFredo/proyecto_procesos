...
from app.api.models.solicitudes_procesos import Solicitud
...
@solicitudes_procesos.post('/create/', tags=['CRUD'])
def post_solicitudes_procesos(solicitud:Solicitud):
    return post(solicitud, conn.rappidron.solicitudes)

@solicitudes_procesos.get('/read/{solicitud_id}/', tags=['CRUD'])
def get_solicitudes_procesos(solicitud_id:str):
    return get('_id', conn.rappidron.solicitudes, solicitud_id)

@solicitudes_procesos.put('/update/{solicitud_id}/', tags=['CRUD'])
def update_solicitudes_procesos(solicitud_id:str, solicitud:Solicitud):
    return put('_id', conn.rappidron.solicitudes, solicitud_id, solicitud)
    
@solicitudes_procesos.delete('/delete/{solicitud_id}/', tags=['CRUD'])
def delete_solicitudes_procesos(solicitud_id:str):
    return delete('_id', conn.rappidron.solicitudes, solicitud_id)
